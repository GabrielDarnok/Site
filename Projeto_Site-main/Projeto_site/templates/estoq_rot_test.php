<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao,"INSERT INTO testes_rot(marca,modelo,quantidade) VALUES ('$marca','$modelo','$quant')");
...
<body>
    ...
    <section class="Tabela">
        <h2>Adicionar em Testes</h2>
    </section>
        <section class="box">
            <form action="estoq_rot_test.php" method="POST"> 
                <fieldset>
