<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao,"INSERT INTO retirada(marca,modelo,quantidade)VALUES ('$marca','$modelo','$quant')");

        header('Location: ont_retirada.php');
    }
...
<body>
    ...
    <section class="Tabela">
        <h2>Adicionar Retirada</h2>
    </section>
        <section class="box">
            <form action="estoq_ont_ret.php" method="POST"> 
                <fieldset>
