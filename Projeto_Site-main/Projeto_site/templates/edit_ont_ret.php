<?php
    ...
    if(!empty($_GET['id']))
    {
        ...
        $sqlSelect = "SELECT * FROM retirada WHERE id=$id";
...
<body>
    ...
    <nav class="menu">
        <h1>ONT</h1>
        <a href="ont.php"><u>Novos</u></a><a href="ont_retirada.php"><u>Retirada</u></a><a href="ont_testes.php"><u>Testes</u></a></u>
    </nav>
    <hr>
    <section class="Tabela">
        <h2>Atualizar em Retirada</h2>
    </section>
        <section class="box">
            <form action="saveEdit_ont_ret.php" method="POST"> 
                <fieldset>
                    <legend><b>Atualizar</b></legend>
                        <section class="inputbox">
                            <br><br>
                            <div class="form">
                                <input type="text" name="marca" id="modelo" class="inputuser" value="<?php echo $marca ?>" required>
                            ...
                            <br><br>
                            <div class="form">
                                <input type="text" name="quant" id="quant" class="inputuser" value="<?php echo $quant ?>" required>
