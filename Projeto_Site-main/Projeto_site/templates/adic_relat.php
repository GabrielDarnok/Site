<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao,"INSERT INTO relat(tipo,rot_mes,onu_mes,ont_mes) VALUES ('$tipo','$rot_mes','$onu_mes','$ont_mes')");
...
<body>
    ...
    <section class="Tabela">
        ...
        <section class="box">
            <form action="adic_relat.php" method="POST"> 
                <fieldset>
                    <legend><b>Adicionar no Relatorio</b></legend>
                    <section class="inputbox">
                            ...
                            <br><br>
                            <div class="form">
                                <input type="text" name="rot" id="rot" class="inputuser" required>
                                <label for="id" class="labelinput">Roteadores</label>
                            </div>
                            <br><br>
                            <div class="form">
                                <input type="text" name="onu" id="onu" class="inputuser" required>
                            <label for="id" class="labelinput">ONU</label>    
                            </div>
                            <br><br>
                            <div class="form">
                                <input type="text" name="ont" id="ont" class="inputuser" required>
