<?php
    ...
    if(!empty($_GET['id']))
    {
        ...
        $sqlSelect = "SELECT * FROM retirada_onu WHERE id=$id";
...
<body>
    ...
    <nav class="menu">
        <h1>ONT</h1>
        <a href="onu.php"><u>Novos</u></a><a href="onu_ret.php"><u>Retirada</u></a><a href="ont_test.php"><u>Testes</u></a></u>
    </nav>
    <hr>
    ...
    <section class="box">
        <form action="saveEdit_onu_ret.php" method="POST"> 
                <fieldset>
